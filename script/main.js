$(document).ready(function(){
    // 1. 입출력 메소드
    /*  F12, CTRL+SHIFT+I, 검사  > Console
        console.log("print some!");    <-- 디버깅할때 주로 사용!
        document.write();
        alert();
    */
